...
namespace osu.Game.Localisation
{
    public static class MaintenanceSettingsStrings
    {
        ...
        /// <summary>
        /// "The target directory already seems to have an osu! or jvnkosu! install. Use that data instead? Game will restart."
        /// </summary>
        public static LocalisableString TargetDirectoryAlreadyInstalledOsu => new TranslatableString(getKey(@"target_directory_already_installed_osu"), @"The target directory already seems to have an osu! or jvnkosu! install. Use that data instead? Game will restart.");
