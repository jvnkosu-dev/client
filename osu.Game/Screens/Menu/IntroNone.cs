...
namespace osu.Game.Screens.Menu
{
    public partial class IntroNone : IntroScreen
    {
        ...
        private NoneIntroSequence intro;
        ...
        protected override void LogoArriving(OsuLogo logo, bool resuming)
        {
            ...
            if (!resuming)
            {
                ...
                LoadComponentAsync(intro = new NoneIntroSequence(logo, () => FadeInBackground())
                {
        ...
        private partial class NoneIntroSequence : CompositeDrawable
        {
            private readonly OsuLogo logo;
            private readonly Action showBackgroundAction;
            public Action LoadMenu;

            public NoneIntroSequence(OsuLogo logo, Action showBackgroundAction)
            {
                this.logo = logo;
            ...
            private const double logo_2 = logo_scale_duration;
