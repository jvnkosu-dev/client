...
namespace osu.Game.Skinning
{
    public class TrianglesSkin : Skin
    {
        ...
        public TrianglesSkin(SkinInfo skin, IStorageResourceProvider resources, IResourceStore<byte[]>? fallbackStore = null, bool useRealmStorage = true)
            : base(skin, resources, fallbackStore, useRealmStorage: useRealmStorage)
        {
