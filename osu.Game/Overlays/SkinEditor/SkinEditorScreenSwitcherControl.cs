...
{
    public partial class SkinEditorScreenSwitcherControl : OsuTabControl<SkinEditorScreenMode>
    {
        public SkinEditorScreenSwitcherControl()
        {
            AutoSizeAxes = Axes.X;
        ...
        protected override Dropdown<SkinEditorScreenMode> CreateDropdown() => null!;

        protected override TabItem<SkinEditorScreenMode> CreateTabItem(SkinEditorScreenMode value) => new TabItem(value);
        ...
        private partial class TabItem : OsuTabItem
        {
            ...
            public TabItem(SkinEditorScreenMode value)
                : base(value)
            {
